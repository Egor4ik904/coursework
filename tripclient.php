...
$SET_PLACE=mysql_query("select * from place where idtrip=$idtrip and idusersystem=$idusersystem");
$COUNT_TRIP=mysql_num_rows($SET_PLACE);	
...
?>
<script language="javascript">
alert("Билет на этот рейс уже забронирован Вами!");
history.back();
</script>
<?	 
exit();
...
$SET_PLACE=mysql_query("select idplace from place where idtrip=$idtrip and status like 'В продаже' LIMIT 1");
$COUNT_TRIP=mysql_num_rows($SET_PLACE);
...
?>
<script language="javascript">
alert("На этот рейс все билеты забронированы!");
history.back();
</script>
<?	 
exit();	 
...
if ($COUNT_TRIP>0)
{//билеты есть
$f=mysql_fetch_array($SET_PLACE);
$idplace=$f["idplace"];
	
mysql_query("update place set idusersystem=$idusersystem where idplace = $idplace");
...
<form name="form2"  method="post"  >
									...
									<div class="card-header">
                                        ...
                                        <div align="right">	
Сортировка:
<select name="sortname"  style="height:22; width:auto" onChange="this.form.action='tripclient.php?sort=1&filter=<? echo $filter;?>'; this.form.submit();" >
...
В: 
				...
				<br>
				<input  type="button"  name="button1"  onclick="this.form.action='tripclient.php?filter=1&sort=<? echo $sort;?>'; this.form.submit();"   value="Фильтр">
				<input  type="button"  name="button2"  onclick="this.form.action='tripclient.php?filter=0&sort=<? echo $sort;?>'; this.form.submit();"   value="Очистить">
                
           <br>
             </div>  
 <div align="left">
<input   type="button"  class="btn btn-success"  name="button"  <? if (mysql_num_rows($r)==0) {?>    disabled="disabled"<? }?>  onclick="this.form.action='tripclient.php?step=2'; this.form.submit();" value="Забронировать билет">   
