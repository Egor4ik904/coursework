...
$s="SELECT place.*, trip.*, airplane, airportin.airport as airportin, airportout.airport as airportout from place, trip, airplane, airport as airportin, airport as airportout where trip.idtrip=place.idtrip and trip.idairplane=airplane.idairplane and trip.idairportin=airportin.idairport and trip.idairportout=airportout.idairport and idusersystem=$idusersystem";
...
<form name="form2"  method="post"  >
									...
									<div class="card-header">
										<div class="card-title">Забронированные билеты </div> 	
                                        <div align="right">	
Сортировка:
				<select name="sortname"  style="height:22; width:auto" onChange="this.form.action='placetripclient.php?sort=1&filter=<? echo $filter;?>'; this.form.submit();" >
				  <option value="place"  <? if ($fieldsort=="place") {?> selected="selected" <? }?>>Билет </option>
                  <option value="trip.idtrip"  <? if ($fieldsort=="trip.idtrip") {?> selected="selected" <? }?> >Номер рейса </option>
...
В: 
				...
				<br>
				<input  type="button"  name="button1"  onclick="this.form.action='placetripclient.php?filter=1&sort=<? echo $sort;?>'; this.form.submit();"   value="Фильтр">
				<input  type="button"  name="button2"  onclick="this.form.action='placetripclient.php?filter=0&sort=<? echo $sort;?>'; this.form.submit();"   value="Очистить">
